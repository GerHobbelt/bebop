...
Tempo is the official RPC framework from 6over3 built on top of Bebop to replace your gRPC and REST APIs. It's designed to be simple, fast, and easy to use.
...
- [Tempo RFCs and Community Discussions](https://github.com/6over3/tempo/discussions/categories/rfc-ideas)